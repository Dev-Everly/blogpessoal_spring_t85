...
public class UsuarioControllerTest {
	...
	@Test
	@DisplayName("03 - Deve listar usuários por ID")
	void listarPorId(){
		
		// given
	 
		Usuario usuarioCadastrado = usuarioService.cadastrarUsuario( 
				TestBuilder.criarUsuario(null, "Bruce Wayne", "morcego@email.com.br","morcego1234")
				).orElseThrow();
				
		usuarioService.cadastrarUsuario( TestBuilder.criarUsuario(null, "Pinguim", 
				"pinguim@email.com.br","pinguim1234"));
